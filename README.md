...
| 🔌 MCP server | The whole toolkit as a 9-tool Model Context Protocol stdio server — query failures from any MCP client | `approximately mcp` |
...
Full design document: [docs/PLAN.md](docs/PLAN.md) · module map: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md).
