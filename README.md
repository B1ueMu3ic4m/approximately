...
| 🔌 MCP server | The whole toolkit as a 22-tool Model Context Protocol stdio server — query failures and agent scoreboards from any MCP client | `approximately mcp` |
